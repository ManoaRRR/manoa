...
import backgroundImage from '../assets/250545.jpg';
...
function Contact() {
  ...
  return (
    <div
        style={{ height: "90vh", backgroundImage: `url(${backgroundImage})`}}
        className=" flex items-center justify-center h-screen bg-cover bg-center bg-no-repeat"
    >
  {/* Conteneur Formulaire */}
  <div className="relative z-10 max-w-md mx-auto overflow-hidden bg-gray-800/90 p-8 rounded-lg shadow-md before:w-24 before:h-24 before:absolute before:bg-orange-800 before:rounded-full before:-z-10 before:blur-2xl after:w-32 after:h-32 after:absolute after:bg-sky-400 after:rounded-full after:-z-10 after:blur-xl after:top-24 after:-right-12">
    <h2 className="w-80 text-3xl font-bold text-gray-400 mb-6 text-center">Contact</h2>
