...
function Home() {
  return (
    <section className="bg-gradient-to-b from-black to-[#080630] min-h-screen text-white h-auto flex items-center overflow-hidden py-6">
  <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center h-full">
    
    {/* Section de droite (image) */}
    <div className="flex justify-center lg:w-1/2 order-1 lg:order-2 mb-6 lg:mb-0">
    ...
    <div className="lg:w-1/2 flex flex-col justify-center order-2 lg:order-1">
      ...
      {/* Grid pour les compétences */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8 text-center">
        {/* Back-end */}
        <div className="flex flex-col items-center bg-gray-800 text-white p-6 rounded-lg transform transition-all duration-500 hover:scale-110 shadow-md hover:bg-gradient-to-r hover:from-blue-900 hover:via-purple-700 hover:to-pink-700">
        ...
        {/* Ops */}
        <div className="flex flex-col items-center bg-gray-800 text-white p-6 rounded-lg transform transition-all duration-500 hover:scale-110 shadow-md hover:bg-gradient-to-r hover:from-blue-900 hover:via-purple-700 hover:to-green-700">
